// From: https://raw.githubusercontent.com/dankogai/js-combinatorics/master/combinatorics.js
/**
 * combinatorics.js
 *
...
class Permutation extends _CBase {
  constructor(seed, size = 0) {
    super();
    this.seed = [...seed];
    this.size = size > 0 ? size : this.seed.length;
  ...
  nth(n) {
    ...
    const digits = factoradic(_BI(n) * _BI(skip), this.seed.length);
