    ...
    appendValues(values) {
        ...
        for (let i1 = 0; i1 < values.length; i1++) {
            ...
            current_y = Math.floor(
                this.height -
                    30 -
                    ((oldvalues[i1] - this.model.y_axis.min) / (this.model.y_axis.max - this.model.y_axis.min)) *
                        (this.height - 30)
            );
            ...
            current_y = Math.floor(
                this.height -
                    30 -
                    ((values[i1] - this.model.y_axis.min) / (this.model.y_axis.max - this.model.y_axis.min)) *
                        (this.height - 30)
            );
